...
<!-- Mirrored from freshcart-furniture.codescandy.com/product-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 08:34:12 GMT -->
<head>
	<meta charset="UTF-8" />
	...
	<title>Product List eCommerce HTML Template - FreshCart Furniture</title>
</head>


<body>
	<!--Pageheader start-->
	@include('layouts-productlist.menu')
	<!--Pageheader end-->
	<!--Breadcrumb start-->
	...
	<!--Product list end-->
    @yield('section-productlist')

	@include('layouts-productlist.footer') <!-- Scroll top -->
