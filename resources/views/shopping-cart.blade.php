...
<!-- Mirrored from freshcart-furniture.codescandy.com/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jan 2025 08:34:18 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <title>Shopping Cart eCommerce HTML Template - FreshCart Furniture</title>
</head>


<body>

    @include('layouts-shoppingcart.header')
	<!--Breadcrumb start-->
	<div class="container">
		<div class="row">
			<div class="col-12 py-4">
				@include('layouts-shoppingcart.menu')
			</div>
			<div class="col-12">
				<!--Heading-->
				<div class="mb-4">
	...
	@include('layouts-shoppingcart.footer') <!-- Scroll top -->
	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="cartOffcanvas" aria-labelledby="cartOffcanvasLabel">
		<div class="offcanvas-header">
			<h5 class="offcanvas-title" id="cartOffcanvasLabel">Cart Summary</h5>
			<button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
		</div>
